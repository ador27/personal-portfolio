...
<div id="asl-search" class="asl-cont asl-search">
    <div class="sl-container">
      <section class="asl-search-cont" <?php echo $bg_color ?>>
        <h2><?php echo esc_attr__('FIND A KIOSK NEAR YOU', 'asl_locator') ?></h2>
        <div class="sl-row">
            <div class="pol-lg-12">
                <div class="sl-row asl-search-widget text-center center-block">
                    <div class="pol-md-<?php echo $search_columns ?> p-0">
                        ...
                        <input data-submit="disable"  id="sl-search-widget-text" class="form-control asl-search-cntrl isp_ignore border-r-0" placeholder="<?php echo esc_attr__( 'Enter a Location', 'asl_locator') ?>">
                        <span class="err-spn"><?php echo esc_attr__( 'Destination missing or invalid', 'asl_locator') ?></span>
                        <a title="<?php echo esc_attr__( 'Current Location', 'asl_locator') ?>" class="sl-geo-btn asl-geo">
                    ...
                    <div class="pol-md p-0">
                        <div class="categories_filter">
                          <select class="form-control border-0" id="asl-<?php echo $a_filter ?>"></select>
                        </div>
                    </div>
                    <?php 
                    endforeach;
                    ...
                    ?>
                    <div class="pol-md p-0">
                        <button id="asl-btn-search" type="button" <?php echo $btn_color ?> class="asl-search-btn border-l-0 btn btn-primary"><?php echo esc_attr__( 'Search', 'asl_locator') ?></button>
                    </div>
                </div>
            </div>
        </div>
